...
#png(paste(chr,group,start_coord, end_coord, "UMR.png",sep="."), width=10, height=6, units="in", res=500)
pdf(paste(chr,group,start_coord, end_coord, "UMR.png",sep="."), width = 10, height = 6)
...
kpRect(chromosome, data=toGRanges(refgenes),x0=refgenes$Start,x1=refgenes$End,y0=0, y1=1,lwd=0.00,r0=0, r1=0.05,col='black',border=NA)
kpAddBaseNumbers(chromosome, tick.dist = 2000000, add.units = FALSE,digits=1,cex=0,tick.len = 8,minor.tick.dist = 1000000, minor.tick.len = 3,clipping=TRUE)
